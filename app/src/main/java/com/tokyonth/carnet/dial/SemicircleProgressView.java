package com.tokyonth.carnet.dial;
...
import com.tokyonth.carnet.dial.utils.PxUtils;
...
public class SemicircleProgressView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        SemicircleSize = typedArray.getDimensionPixelSize(R.styleable.SemicircleProgressView_semicircleSize, PxUtils.dpToPx(100,getContext()));
        SemicirclelineSize = typedArray.getDimensionPixelSize(R.styleable.SemicircleProgressView_semicirclelineSize, PxUtils.dpToPx(3,getContext()));
        ...
        semicircletitleSize = typedArray.getDimensionPixelSize(R.styleable.SemicircleProgressView_semicircletitleSize, PxUtils.spToPx(20,getContext()));
        semicirclesubtitleSize = typedArray.getDimensionPixelSize(R.styleable.SemicircleProgressView_semicirclesubtitleSize, PxUtils.spToPx(17,getContext()));
...
//        matrix.postTranslate(pos[0] - bitmap.getWidth() / 2, pos[1] - bitmap.getHeight() / 2);
    ...
    private void drawCenterText(Canvas canvas) {
        ...
        canvas.drawText(Title, (maxWidth / 2), (maxHeight / 2) - PxUtils.dpToPx(10,getContext()), mTextPaint);
        //绘制SubTile
        mTextPaint2.setTextSize(semicirclesubtitleSize);
        canvas.drawText(SubTile, (maxWidth / 2), (maxHeight / 2) + PxUtils.dpToPx(10,getContext()), mTextPaint2);
