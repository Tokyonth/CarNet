...
public class PushBaseActivity extends Application {

    private String TAG = "TOKYONTH -------->";
    // 使用自己APP的ID（官网注册的）
    private static final String APP_ID = "2882303761517956461";
    // 使用自己APP的Key（官网注册的）
    private static final String APP_KEY = "5441795619461";
    //推送服务状态量
        ...
        AppHandler = new Handler(mHandlerThread.getLooper()){
            ...
            public void handleMessage(Message msg) {
                ...
                switch(msg.what){
                    ...
                    //1=延时注册推送服务
                    case 1:
                        Log.d(TAG,"正在回调延时(1分钟)注册推送服务....");
                        try {
                            Thread.sleep(10000);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                        Log.d(TAG,"延时完毕,开始重新注册推送服务");
                        startPush();
                        break;
                    //2=注册广播
                    case 2:
